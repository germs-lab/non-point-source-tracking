...
combo='source.river.cow.30.sink.10.combined.fa'
...
combo='source.river.cow.30.sink.1.combined.fa'

cat $source1 $source2 $source3 $sink > $combo
pick_de_novo_otus.py -i $combo -o $combo-qiime-denovo/otus/ -p param.txt -f


bash source.sh.30-denovo.sh